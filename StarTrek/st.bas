...
39991 REM *********************************************************
4000 IF D(3)<0 THEN PRINT "LONG RANGE SENSORS ARE INOPERABLE":GOTO1990
...
4450 H1=INT(X/K3)
4451 FOR I=1 TO 3:
4452    IF K(I,3) <= 0 THEN 4670
4480    H = INT((H1/FND(0))*(RND(1)+2))
4481    IF H > .15 * K(I,3) THEN 4530
...
5001 REM **** Z3 = 0 IF A$ DOESN'T MATCH ELSE 1
...
5111 K3=K3-1
5112 K9=K9-1
5113 IF K9 <= 0 THEN 6370
5150 FOR I=1 TO 3
5151    IF X3=K(I,1) AND Y3=K(I,2) THEN 5190
5180 NEXTI
5181 I=3
...
5911 FOR R1=1 TO 8
5920    GOSUB 8790
5921    PRINTG2$;LEFT$(Z$,25-LEN(G2$));INT(D(R1)*100)*.01
5950 NEXT R1
5951 PRINT
5952 IF D0 <> 0 THEN5720
5980 GOTO 1990
...
6140    R1=FNR(1)
6141    D(R1) = D(R1) - H / S - .5 * RND(1) : GOSUB8790
...
8270    IF A=0 THEN C1=5 : GOTO8290
8280    C1=1
